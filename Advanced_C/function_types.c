...
inline static int inlinefunction(double n); //when using inline on a function it suggests the compiler to run this function first
//the inline function must be static

_Noreturn void noreturnfunction(); //the _Noreturn specifier was introduced in C11, and it used to suggest users and the compiler the function doesnt return
