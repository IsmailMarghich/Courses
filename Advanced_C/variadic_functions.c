...
int variadicfunction(int variable1, ...) //to add variadic arguments to a function, you add 3 dots ... in the function definition
{
    ...
    int variable2 = va_arg(parg, int); //we can constantly call va_arg function to get the first, and then next argument everytime we call it again
