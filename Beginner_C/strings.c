...
int main(void) {
    ...
    strcat(string1,
           string2); //strcat concatenates first string with second string, and assigns the new string to first string
    printf("%s\n", string1);
    ...
    strncpy(string1, stringcopy,
            100); //this is for when u dont have a set size for the char array, and you can set the max size of the char array with third argument
    printf("%s\n", string1);

    printf("%d\n", strcmp("A",
                          "A")); //strcmp compares the string, returns 0 if equal, -1 if first string is smaller than second string, 1 if first string is bigger than second string
    printf("%d\n", strcmp("A", "B"));
    ...
    pChar_pointer = strchr(str,
                           ch); //the strchr string will find the a character specified in second argument in a string in first argument
    ...
    printf("%c",
           toupper('g')); //with toupper or tolower function we can convert a character or string (using a loop and iterating) to upper or lowercase
