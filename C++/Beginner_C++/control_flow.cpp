...
int main(){
    ...
    switch (number){ //we enter a condition in the braces
        case 1: cout << "1 is for unity" << endl; break; //then we make cases for each value of number
        case 2: cout << "2 is for duo's" << endl; break;
        case 3: cout << "3 is for pyramids and triangles" << endl; break;
