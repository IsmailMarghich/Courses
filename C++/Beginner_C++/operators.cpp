...
int main(){
    ...
    average = static_cast<double> (a + b) / 2; //we cast the expression to a double, now it will have numbers after period
    ...
    cout << ! (positive && positive) << endl; // ! returns the opposite value, so true becomes false, and false becomes true
